          ...
          <>
            <div className="project-grid">
              {paginatedProjects.map((project) => {
                const totalDonated = parseFloat(project.totalDonated);
                const goal = parseFloat(project.goal) || 0.01;
                ...
                return (
                  <div key={project.id} className="project-card">
                    ...
                    <div className="project-content">
                      <h3>{project.name}</h3>
                      <p>
                        <strong>Tổng quyên góp:</strong> {totalDonated} ETH
                      </p>
                      <p>
                        <strong>Mục tiêu:</strong> {goal} ETH
                      </p>
                      ...
                      <p>
                        <strong>Tiến độ:</strong> {progress.toFixed(2)}%
                      </p>
                      <p>
